...
object StashDemo extends App {
  ...
  // stashes allow actors to put messages aside for later so that they should not process messages at that time
  // when the time is right, prepend to the mailbox and process them
  /*
    ResourceActor
